...
import { storeTokens, getAccessToken, getRefreshToken, clearTokens } from './token.store.js';
...
export const handleRaindropCallback = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error('Erreur lors de l\'échange du code contre un token:', errorData || errorMessage);
...
export const getUserCollections = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error('Erreur lors de la récupération des collections Raindrop:', errorData || errorMessage);
...
export const refreshToken = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error('Erreur lors du rafraîchissement du token:', errorData || errorMessage);
